...
public class adaptador extends BaseAdapter {
    ...
    public adaptador(Activity activity, ArrayList<Mascota> lista, daoMascota dao) {
        this.lista = lista;
        this.dao = dao;
    ...
    public View getView(int posicion, View view, ViewGroup viewGroup) {
        ...
        editar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final EditText nombre = dialogView.findViewById(R.id.txtnombre);
                final EditText edad = dialogView.findViewById(R.id.txtedad);
                final EditText tipoDeAnimal = dialogView.findViewById(R.id.txttipoDeAnimal);
                final EditText raza = dialogView.findViewById(R.id.txtraza);
                final EditText telefono = dialogView.findViewById(R.id.txttelefono);
                ...
                btnConfirmar.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        try {
                            a = new Mascota((int) getSelectedId(), nombre.getText().toString(),
